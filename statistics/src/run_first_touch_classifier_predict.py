...
from src.models.first_touch_classifier import load_model_pack, predict_first_touch_probabilities_for_date
...
DEFAULT_OUT_JSON_PATH = OUT_DIR / "first_touch_classifier" / "prediction.json"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Predict short-horizon SAFE first-touch probabilities from the full SAFE state.",
    )
    ...
    parser.add_argument("--model-path", default=str(DEFAULT_MODEL_PATH), help="Default: ../out/first_touch_classifier/model.joblib")
...
def main() -> None:
    ...
    prediction = predict_first_touch_probabilities_for_date(
        model_pack,
    ...
    print(f"Horizon: {prediction['days']}d")
    print(
